...
self.fastpath,
self.entry.entry1, self.entry.entryA, self.entry.entryB, self.entry.entryC,
...
batch.req002.findentry_cli, batch.req002.entry_log, batch.req002.findentry_payload,
...
self.stub.conda_retry, self.stub.pip_warn,
self.dep.diff.trace,
