...
# Legacy notice: the live diagnostics site is generated by tools/diag/publish_index.ps1.
# These Python-based diagnostics tests are retained for historical reference only and
# should not drive future changes to the publishing pipeline.
raise unittest.SkipTest(
    "Legacy Python diagnostics publisher tests are disabled; the live site uses"
    " tools/diag/publish_index.ps1."
)
