...
if (-not $condaBat) {
    ...
    # derived requirement: in uv-first lanes (HP_FORCE_CONDA_ONLY not set), Miniconda is
    # never installed so these conda-specific tests are not applicable -- emit skip=true.
