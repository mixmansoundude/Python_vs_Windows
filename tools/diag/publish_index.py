...
Legacy notice: ``tools/diag/publish_index.ps1`` is deprecated; this Python
publisher now drives the live GitHub Pages diagnostics site.
"""
...
def _write_html(
    ...
    # Professional note: embed the active publisher to disambiguate from the
    # legacy PowerShell implementation and keep diagnostics runs traceable when
    # the tooling changes.
    html.append("<p class=\"publisher-note\">Publisher: tools/diag/publish_index.py (Python)</p>")
