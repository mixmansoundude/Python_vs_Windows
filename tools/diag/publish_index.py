...
Legacy notice: the live GitHub Pages diagnostics site is generated by
``tools/diag/publish_index.ps1``. This Python implementation is retained for
reference only and is not authoritative for /diag output.
"""
